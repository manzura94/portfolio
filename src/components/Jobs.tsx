            ...
            <ol>
                <li className='mb-12 p-5 rounded-[10px] group cursor-pointer transition-colors duration-300 hover:bg-[rgba(148,163,184,0.1)]'>
                    <div className='flex gap-10'>
                        <div className='w-[20%] mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 '>Nov 2024 - PRESENT</div>
                        <div>
                            ...
                            <p className='mt-2 text-sm leading-normal text-slate-400'>
                                Build and maintain critical components used to construct frontend for projects, across the whole product. Work closely with cross-functional teams,
                                including developers, designers, and product managers, to implement and advocate for best practices in web accessibility.
                            </p>
