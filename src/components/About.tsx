...
const About = () => {
    return (
        <section id='about' className='mb-10 scroll-mt-16 md:mb-14 lg:mb-16 lg:scroll-mt-24'>
            ...
            <p className='mb-4 leading-normal text-slate-400'>
                ...
                , specializing in accessibility. I contribute to the creation and maintenance of UI components that power frontend of our projects, ensuring our platform meets web
            ...
            <p className='mb-4 leading-normal text-slate-400'>
                ...
                , where I contributed to building admin panels and enhancing user interfaces. I also actively work on personal and open-source projects, striving for excellence in
                both design and functionality. Debugging and problem-solving are key parts of my process, as I view every challenge as an opportunity to learn and improve.
            </p>
        </section>
    );
};
